...
class Blockchain(object):
    ...
    def hash(self, block):
        ...
        # json.dumps = python version of json.stringify
    ...
    # TODO: Remove Proof of Work Function from BlockChain
    ...
    def valid_proof(block_string, proof):
        ...
        # TODO: Make valid proof need 6 leading zeros
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        print(f'NEW TRANSACTION - post: len = {len(self.current_transactions)}')
...
@app.route('/transactions/now', methods=['POST'])
def post_new_transaction():
    ...
    blockchain.new_transaction( data['sender'],
                                data['recipient'],
                                data['amount'])
...
def mine():
    ...
    if 'proof' not in data or 'id' not in data: 
        response = {'message': 'missing required property'}
        return jsonify(response), 400
    ...
    if blockchain.valid_proof(block_string, proof):
        ...
        # blockchain.new_transaction(miner_id, '0', 2)
